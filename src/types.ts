...
export interface RecurringBill {
   ...
   *  utils/pushNotifications.ts, страница «Уведомления» в Настройках). У
   *  платежей, созданных до этого поля, undefined — считаем как включено.
   *  На баннер/бейдж «скоро/просрочено» в самом приложении не влияет. */
